...
class FindProducts(generic.TemplateView):
	...
	def get(self, request, *args, **kwargs):
		...
		return render(request, self.template_name,{'get_prod':get_prod,'q_list':q_list,'q_sort_by':q_sort_by,'get_filter_fabric_product':get_filter_fabric_product,'get_products_subcat':get_products_subcat,'get_filter_products_subcat':get_filter_products_subcat,'get_fabric_product':get_fabric_product,'get_products':get_products,'get_system_settings':get_system_settings})
...
class ProductDetail(generic.TemplateView):
	...
	def get(self, request, id,*args, **kwargs):
		...
		return render(request, self.template_name,{'get_payment':get_payment,'get_color_list':get_color_list,'get_product_instance':get_product_instance,'get_system_settings':get_system_settings})
